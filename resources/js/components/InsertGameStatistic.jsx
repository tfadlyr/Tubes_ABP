...
export default function InsertGameStatistic() {
          ...
          <CardContent>
              <Box sx={{height: 300, width: 368, backgroundColor: "#5972CA", padding: 4, borderRadius: 4}}>
                  <Stack justifyContent='center' alignItems='center' spacing={2}>
                      ...
                      <Button variant="contained" onClick={handleClose} sx={{height: 34, width: 104, backgroundColor: '#D9D9D9', padding: 1}}>Insert</Button>
                  </Stack>
              </Box>
          </CardContent>
        </Card>
