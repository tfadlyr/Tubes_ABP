...
export default function UpdateGameStatistic() {
          ...
          <CardContent>
              <Box sx={{height: 300, width: 368, backgroundColor: "#5972CA", padding: 4, borderRadius: 4}}>
                  <Stack justifyContent='center' alignItems='center' spacing={2}>
                      ...
                      <TextField label="Date"></TextField>
                      <TextField label="Peak"></TextField>
                      <Grid sx={{display: 'flex', gap: 1}}>
                        <Button variant="contained" onClick={handleClose} sx={{height: 34, width: 104, backgroundColor: '#D9D9D9', padding: 1}}>Update</Button>
                        <Button variant="contained" onClick={handleClose} sx={{height: 34, width: 104, backgroundColor: '#D9D9D9', padding: 1}}>Delete</Button>
                      </Grid>
                  </Stack>
              </Box>
          </CardContent>
